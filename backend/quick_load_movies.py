"""
Quick Movie Data Loader - Non-interactive version
Loads a small set of movies for testing
"""
import sys
import time
...
from app.load_tmdb_data import safe_api_call

def quick_load():
    """Load a quick set of movies for testing"""
    print("\n" + "="*60)
    print("QUICK MOVIE LOADER")
    print("="*60 + "\n")
    ...
    try:
        print("📽️  Loading Popular Movies (2 pages)...")
        
        total_loaded = 0
        
        for page in range(1, 3):  # Just 2 pages = ~40 movies
